...
* *The term shared memory is a term used to describe a type of memory management in the Unix kernel.  It is a memory region that can shared between different processes. This is where semaphores come into play. Basically, flags that are either on or off.*
...
*/
```
* *67,108,864 = 64x1024x1024 = 64MB* 
* *17,179,869,184 = 16x1024x1024x1024 = 16GB*
